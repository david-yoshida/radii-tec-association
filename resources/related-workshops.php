...
if ( is_array( $posts ) && ! empty( $posts ) ) {
	...
	foreach ( $posts as $post ) {
		...
		$thumb = ( has_post_thumbnail( $post->ID ) ) ? get_the_post_thumbnail( $post->ID, 'large' ) : '<img src="' . trailingslashit( Tribe__Events__Pro__Main ::instance()->pluginUrl ) . 'resources/images/tribe-related-events-placeholder.png" alt="' . get_the_title( $post->ID ) . '" />';;
